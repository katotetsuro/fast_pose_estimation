...
from pose_proposal_networks.datasets.coco import CocoKeypoint
from pose_proposal_networks.pose_proposal_network import PoseProposalNetwork
...
def main():
    ...
    # Data loading code
    def _transform(img, b1, b2):
        img, b1, b2 = model.resize(img, b1, b2)
